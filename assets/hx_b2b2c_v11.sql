/*
 ...
 Source Schema         : hx_b2b2c_p

 Target Server Type    : MySQL
 Target Server Version : 80035
 File Encoding         : 65001

 Date: 28/06/2026 06:25:13
*/
...
CREATE TABLE `ad_content`  (
  ...
  `mmc_tenant_id` bigint NULL DEFAULT NULL COMMENT '商户ID(空=全局)',
  `title` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '广告标题',
  `image_url` varchar(512) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '图片URL',
  `link_type` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '跳转类型: page=内部页面, url=外部链接, mini_program=小程序页面',
  `link_url` varchar(512) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '跳转地址',
  `sort_order` int NULL DEFAULT NULL COMMENT '排序',
  `effective_start` datetime NULL DEFAULT NULL COMMENT '生效开始',
  `effective_end` datetime NULL DEFAULT NULL COMMENT '生效结束',
  `status` tinyint NOT NULL DEFAULT 1 COMMENT '状态: 0=禁用, 1=启用',
  `created_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `updated_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_slot_id`(`slot_id` ASC) USING BTREE,
  INDEX `idx_mmc_tenant_id`(`mmc_tenant_id` ASC) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '广告内容表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `ad_slot`  (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '主键',
  `slot_code` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '广告位编码(唯一)',
  `slot_name` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '广告位名称',
  `slot_type` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '类型: banner=轮播图, popup=弹窗, float=浮动, fixed=固定',
  `position` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '位置: home_top=首页顶部, home_middle=首页中部, order_success=下单成功页等',
  `width` int NULL DEFAULT NULL COMMENT '宽度(px)',
  `height` int NULL DEFAULT NULL COMMENT '高度(px)',
  `status` tinyint NOT NULL DEFAULT 1 COMMENT '状态: 0=禁用, 1=启用',
  `created_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `updated_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `uk_slot_code`(`slot_code` ASC) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '广告位表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `after_sale`  (
  ...
  `after_sale_no` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '售后单号(唯一)',
  `order_id` bigint NOT NULL COMMENT '关联订单ID',
  `order_item_id` bigint NULL DEFAULT NULL COMMENT '关联订单项ID',
  `biz_type` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '业务类型: flight/hotel/train/mall/car/insurance',
  `biz_id` bigint NULL DEFAULT NULL COMMENT '业务售后表ID',
  `user_id` bigint NOT NULL COMMENT 'C端用户ID',
  `type` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '售后类型: refund=退款, return=退货, exchange=换货, change=改签',
  `reason` varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '售后原因',
  `amount` decimal(12, 2) NULL DEFAULT NULL COMMENT '售后金额',
  `status` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '状态: pending/approved/rejected/processing/completed/cancelled',
  `trace_id` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '全链路追踪ID',
  `created_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `updated_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE,
  ...
  INDEX `idx_biz_type`(`biz_type` ASC, `biz_id` ASC) USING BTREE,
  INDEX `idx_status`(`status` ASC) USING BTREE,
  INDEX `idx_trace_id`(`trace_id` ASC) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '全局售后总表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for after_sale_flight
-- ----------------------------
...
CREATE TABLE `after_sale_flight`  (
  ...
  `type` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '售后类型: refund=退票, change=改签',
  `refund_fee` decimal(12, 2) NULL DEFAULT NULL COMMENT '退票费',
  `refund_amount` decimal(12, 2) NULL DEFAULT NULL COMMENT '退款金额',
  `change_flight_info` json NULL COMMENT '改签航班信息',
  `change_fee` decimal(12, 2) NULL DEFAULT NULL COMMENT '改签费',
  `pnr` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT 'PNR',
  `ticket_nos` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL COMMENT '票号(逗号分隔)',
  `created_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `updated_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_after_sale_id`(`after_sale_id` ASC) USING BTREE,
  INDEX `idx_order_item_flight_id`(`order_item_flight_id` ASC) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '机票售后表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for after_sale_hotel
-- ----------------------------
...
CREATE TABLE `after_sale_hotel`  (
  ...
  `type` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '售后类型: refund=退款, change=修改',
  `refund_amount` decimal(12, 2) NULL DEFAULT NULL COMMENT '退款金额',
  `refund_fee` decimal(12, 2) NULL DEFAULT NULL COMMENT '退款手续费',
  `change_room_info` json NULL COMMENT '修改房型信息',
  `change_fee` decimal(12, 2) NULL DEFAULT NULL COMMENT '修改费',
  ...
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_after_sale_id`(`after_sale_id` ASC) USING BTREE,
  INDEX `idx_order_item_hotel_id`(`order_item_hotel_id` ASC) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '酒店售后表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for after_sale_train
-- ----------------------------
...
CREATE TABLE `after_sale_train`  (
  ...
  `refund_fee` decimal(12, 2) NULL DEFAULT NULL COMMENT '退票费',
  `refund_amount` decimal(12, 2) NULL DEFAULT NULL COMMENT '退款金额',
  `change_train_info` json NULL COMMENT '改签车次信息',
  `change_fee` decimal(12, 2) NULL DEFAULT NULL COMMENT '改签费',
  `created_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `updated_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_after_sale_id`(`after_sale_id` ASC) USING BTREE,
  INDEX `idx_order_item_train_id`(`order_item_train_id` ASC) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '火车票售后表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `announcement`  (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '主键',
  `tenant_id` bigint NOT NULL COMMENT '租户ID',
  `tenant_type` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '租户类型: pmc/tmc/mmc',
  `title` varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '公告标题',
  `content` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '公告内容',
  `type` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'notice' COMMENT '类型: notice=通知, activity=活动, policy=政策',
  ...
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_tenant`(`tenant_id` ASC, `tenant_type` ASC) USING BTREE,
  INDEX `idx_type`(`type` ASC) USING BTREE,
  INDEX `idx_status`(`status` ASC) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '公告管理表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for approval_condition_group
-- ----------------------------
...
CREATE TABLE `approval_condition_group`  (
  ...
  `group_name` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '条件组名称',
  `is_default` tinyint NOT NULL DEFAULT 0 COMMENT '是否默认分支(0=否, 1=是)',
  `sort_order` int NULL DEFAULT NULL COMMENT '排序',
  `created_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_node_id`(`node_id` ASC) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '审批条件组表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for approval_condition_item
-- ----------------------------
...
CREATE TABLE `approval_condition_item`  (
  ...
  `field_key` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '条件字段: amount/days/department等',
  `operator` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '运算符: eq=等于, neq=不等于, gt=大于, gte=大于等于, lt=小于, lte=小于等于, in=包含, between=区间',
  `field_value` json NOT NULL COMMENT '条件值(JSON)',
  `logic` varchar(8) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'AND' COMMENT '逻辑: AND/OR',
  `sort_order` int NULL DEFAULT NULL COMMENT '排序',
  `created_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_group_id`(`group_id` ASC) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '审批条件项表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for approval_edge
-- ----------------------------
...
CREATE TABLE `approval_edge`  (
  ...
  `edge_type` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '连线类型: normal=正常, condition=条件分支',
  `condition_group_id` bigint NULL DEFAULT NULL COMMENT '条件组ID',
  `label` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '连线标签',
  `sort_order` int NULL DEFAULT NULL COMMENT '排序',
  `created_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `updated_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE,
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '审批流程连线表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `approval_flow`  (
  ...
  `flow_code` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '流程编码 如WF202606140001',
  `flow_name` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '流程名称',
  `flow_type` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '流程类型: travel_approval=差旅审批, expense_approval=费用审批',
  ...
  `deleted_at` datetime NULL DEFAULT NULL COMMENT '软删除时间',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `uk_flow_code_version`(`tenant_id` ASC, `flow_code` ASC, `version` ASC) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '审批流程定义表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `approval_form`  (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '主键',
  `flow_id` bigint NOT NULL COMMENT 'FK→approval_flow.id',
  `form_name` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '表单名称',
  `form_config` json NOT NULL COMMENT '表单配置(字段列表/验证规则/布局)',
  `created_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `updated_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_flow_id`(`flow_id` ASC) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '审批表单设计表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `approval_instance`  (
  ...
  `instance_no` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '审批单号(平台生成)',
  `title` varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '审批标题',
  `biz_type` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '业务类型: travel=差旅, expense=费用, reimbursement=报销',
  `mode_type` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '审批模式: pre_order=先审后单, approval_order=审批下单, post_order=先付后审',
  `initiator_type` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '发起人端: mmc=商户端, c=客户端',
  `initiator_id` bigint NOT NULL COMMENT '发起人ID(mmc_user.id / c_user.id)',
  `initiator_name` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '发起人姓名',
  `mmc_id` bigint NULL DEFAULT NULL COMMENT '所属商户ID',
  `order_id` bigint NULL DEFAULT NULL COMMENT '关联订单ID(模式2/3时有值)',
  `biz_data` json NULL COMMENT '业务数据快照(航线/乘机人/金额等)',
  `status` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'pending' COMMENT '状态: pending=审批中, approved=已通过, rejected=已拒绝, cancelled=已撤销, terminated=已终止, expired=已超时',
  `oa_platform` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT 'OA平台: dingtalk=钉钉, feishu=飞书, wecom=企业微信',
  `oa_instance_id` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT 'OA平台审批实例ID',
  `oa_process_code` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT 'OA平台流程代码',
  `oa_callback_id` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT 'OA回调标识(用于幂等校验)',
  `oa_sync_status` tinyint NOT NULL DEFAULT 0 COMMENT 'OA同步状态: 0=未同步, 1=已同步, 2=同步失败',
  `oa_sync_error` varchar(512) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT 'OA同步失败原因',
  `oa_sync_at` datetime NULL DEFAULT NULL COMMENT 'OA同步时间',
  `approval_deadline` datetime NULL DEFAULT NULL COMMENT '审批截止时间(超时自动处理)',
  `expired_action` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '超时处理: auto_reject=自动拒绝, auto_cancel=自动撤销, notify=仅通知',
  `approved_at` datetime NULL DEFAULT NULL COMMENT '审批通过时间',
  `rejected_at` datetime NULL DEFAULT NULL COMMENT '审批拒绝时间',
  ...
  `deleted_at` datetime NULL DEFAULT NULL COMMENT '软删除时间',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `uk_instance_no`(`instance_no` ASC) USING BTREE,
  UNIQUE INDEX `uk_oa_instance`(`oa_platform` ASC, `oa_instance_id` ASC) USING BTREE,
  INDEX `idx_tenant_status`(`tenant_id` ASC, `status` ASC) USING BTREE,
  INDEX `idx_initiator`(`initiator_type` ASC, `initiator_id` ASC) USING BTREE,
  INDEX `idx_mmc`(`mmc_id` ASC) USING BTREE,
  INDEX `idx_order`(`order_id` ASC) USING BTREE,
  INDEX `idx_trace_id`(`trace_id` ASC) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '审批实例表(对接第三方OA)' ROW_FORMAT = Dynamic;
...
CREATE TABLE `approval_node`  (
  ...
  `node_type` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '节点类型: start=开始, condition=条件分支, approval=人工审批, auto_pass=自动通过, auto_reject=自动拒绝, end=结束',
  `approval_type` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '审批类型: manual=人工审核, auto_pass=自动通过, auto_reject=自动拒绝',
  `approver_type` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '审批人类型: role=角色, superior=上级, self=发起人, specified=指定成员, multi_superior=连续多级上级, self_select=自选',
  `approver_ids` json NULL COMMENT '审批人ID列表(JSON数组)',
  `multi_approval_mode` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '多人审批方式: sequential=依次审批, countersign=会签, or_sign=或签',
  `empty_handler` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '审批人为空处理: admin=转交审批管理员, specified=指定人员',
  `empty_handler_id` bigint NULL DEFAULT NULL COMMENT '指定人员ID',
  `position_x` int NULL DEFAULT NULL COMMENT '画布X坐标',
  `position_y` int NULL DEFAULT NULL COMMENT '画布Y坐标',
  `sort_order` int NULL DEFAULT NULL COMMENT '排序',
  `created_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `updated_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_flow_id`(`flow_id` ASC) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '审批流程节点表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `approval_record`  (
  ...
  `node_name` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '审批节点名称(如:直属上级审批)',
  `action` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '操作: agree=同意, reject=拒绝, transfer=转交, add_sign=加签, cancel=撤销, terminate=终止',
  `operator_id` bigint NULL DEFAULT NULL COMMENT '操作人ID(平台用户ID,可能为空)',
  `operator_name` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '操作人姓名',
  `operator_oa_id` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT 'OA平台用户ID',
  `operator_oa_name` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT 'OA平台用户姓名',
  `opinion` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL COMMENT '审批意见/备注',
  `attachment` json NULL COMMENT '附件列表(JSON)',
  `oa_callback_data` json NULL COMMENT 'OA回调原始数据(用于审计和问题排查)',
  `transfer_to_id` bigint NULL DEFAULT NULL COMMENT '转交给(用户ID)',
  `transfer_to_name` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '转交给(姓名)',
  `add_sign_user_ids` json NULL COMMENT '加签人ID列表',
  `trace_id` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '全链路追踪ID',
  ...
  INDEX `idx_trace_id`(`trace_id` ASC) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '审批记录表(对接第三方OA)' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '上传文件信息表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `comment_image`  (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '主键',
  `comment_type` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '评论类型: order/mall',
  `comment_id` bigint NOT NULL COMMENT '评论ID',
  `image_url` varchar(512) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '图片URL',
  `sort_order` int NULL DEFAULT NULL COMMENT '排序',
  `created_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_comment`(`comment_type` ASC, `comment_id` ASC) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '评论图片表(通用)' ROW_FORMAT = Dynamic;
...
CREATE TABLE `comment_order`  (
  ...
  `biz_type` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '业务类型: flight/hotel/train/car',
  `user_id` bigint NOT NULL COMMENT 'C端用户ID',
  `is_anonymous` tinyint NOT NULL DEFAULT 0 COMMENT '是否匿名(0=否, 1=是)',
  `overall_score` tinyint NOT NULL DEFAULT 5 COMMENT '综合评分(1-5)',
  `service_score` tinyint NULL DEFAULT NULL COMMENT '服务评分(1-5)',
  `price_score` tinyint NULL DEFAULT NULL COMMENT '价格评分(1-5)',
  `experience_score` tinyint NULL DEFAULT NULL COMMENT '体验评分(1-5)',
  `content` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL COMMENT '评论内容',
  `reply_content` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL COMMENT '商户/平台回复',
  `reply_at` datetime NULL DEFAULT NULL COMMENT '回复时间',
  `reply_by` bigint NULL DEFAULT NULL COMMENT '回复人ID',
  `append_content` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL COMMENT '追评内容',
  `append_at` datetime NULL DEFAULT NULL COMMENT '追评时间',
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '订单评论表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `coupon`  (
  ...
  `coupon_type` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '类型: discount=折扣券, reduction=满减券, cash=直减券, flight=机票券, hotel=酒店券, general=通用券',
  `apply_type` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '适用: flight=机票, hotel=酒店, train=火车票, mall=商城, general=通用',
  `discount_rate` decimal(3, 2) NULL DEFAULT NULL COMMENT '折扣率(0.85=85折)',
  `reduction_threshold` decimal(12, 2) NULL DEFAULT NULL COMMENT '满减门槛金额',
  `reduction_amount` decimal(12, 2) NULL DEFAULT NULL COMMENT '满减/直减金额',
  `total_count` int NOT NULL DEFAULT 0 COMMENT '发放总量(0=不限)',
  `used_count` int NOT NULL DEFAULT 0 COMMENT '已使用数量',
  `per_user_limit` int NOT NULL DEFAULT 1 COMMENT '每人限领',
  `effective_start` datetime NULL DEFAULT NULL COMMENT '生效开始',
  `effective_end` datetime NULL DEFAULT NULL COMMENT '生效结束',
  `valid_days` int NULL DEFAULT NULL COMMENT '领取后有效天数(替代固定时间)',
  `status` tinyint NOT NULL DEFAULT 1 COMMENT '状态: 0=禁用, 1=启用',
  `created_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `updated_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  `deleted_at` datetime NULL DEFAULT NULL COMMENT '软删除时间',
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '通用优惠券模板表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `coupon_user`  (
  ...
  `user_id` bigint NOT NULL COMMENT 'C端用户ID',
  `status` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'unused' COMMENT '状态: unused=未使用, used=已使用, expired=已过期',
  `received_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '领取时间',
  `used_at` datetime NULL DEFAULT NULL COMMENT '使用时间',
  `order_id` bigint NULL DEFAULT NULL COMMENT '使用时关联订单',
...
CREATE TABLE `decorate_page`  (
  ...
  `page_type` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '页面类型: home=首页, category=分类, custom=自定义页',
  ...
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_mmc_tenant_id`(`mmc_tenant_id` ASC) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '小程序装修页面表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `favorite`  (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '主键',
  `user_id` bigint NOT NULL COMMENT 'C端用户ID',
  `biz_type` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '业务类型: flight/hotel/mall',
  `biz_id` bigint NOT NULL COMMENT '业务对象ID',
  `title` varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '标题(冗余)',
  `image` varchar(512) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '封面图(冗余)',
  `mmc_tenant_id` bigint NULL DEFAULT NULL COMMENT '归属商户ID',
  `created_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `uk_user_biz`(`user_id` ASC, `biz_type` ASC, `biz_id` ASC) USING BTREE,
  INDEX `idx_user_id`(`user_id` ASC) USING BTREE,
  INDEX `idx_biz_type`(`biz_type` ASC) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '全局收藏总表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for favorite_flight
-- ----------------------------
DROP TABLE IF EXISTS `favorite_flight`;
CREATE TABLE `favorite_flight`  (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '主键',
  `favorite_id` bigint NOT NULL COMMENT 'FK→favorite.id',
  `departure_code` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '出发城市代码',
  `arrival_code` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '到达城市代码',
  `departure_name` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '出发城市名称',
  `arrival_name` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '到达城市名称',
  `airline_code` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '航司代码',
  `cabin_class` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '舱位等级',
  `price` decimal(12, 2) NULL DEFAULT NULL COMMENT '收藏时价格',
  `flight_date` date NULL DEFAULT NULL COMMENT '航班日期',
  `created_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_favorite_id`(`favorite_id` ASC) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '机票收藏附表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `favorite_hotel`  (
  ...
  `hotel_name` varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '酒店名称',
  `city_code` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '城市代码',
  `star_rate` tinyint NULL DEFAULT NULL COMMENT '星级',
  `min_price` decimal(12, 2) NULL DEFAULT NULL COMMENT '最低价',
  `created_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_favorite_id`(`favorite_id` ASC) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '酒店收藏附表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for favorite_mall
-- ----------------------------
...
CREATE TABLE `favorite_mall`  (
  ...
  `goods_name` varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '商品名称',
  `price` decimal(12, 2) NULL DEFAULT NULL COMMENT '收藏时价格',
  `created_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_favorite_id`(`favorite_id` ASC) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '商品收藏附表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `member_benefit`  (
  ...
  `benefit_type` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '权益类型: discount=折扣, coupon=专属优惠券, point_rate=积分倍率, free_upgrade=免费升舱, priority_service=优先服务',
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '会员权益表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for member_grade_rule
-- ----------------------------
...
CREATE TABLE `member_grade_rule`  (
  ...
  `rule_type` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '规则类型: point=积分达到, order_count=订单数达到, amount_total=消费金额达到',
  ...
  `downgrade_rule` json NULL COMMENT '降级规则(如N天未消费)',
  `status` tinyint NOT NULL DEFAULT 1 COMMENT '状态: 0=禁用, 1=启用',
  `created_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `updated_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_mmc_tenant_id`(`mmc_tenant_id` ASC) USING BTREE,
  INDEX `idx_grade`(`from_grade_id` ASC, `to_grade_id` ASC) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '会员升级规则表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = 'Merchant部门' ROW_FORMAT = Dynamic;
...
CREATE TABLE `mmc_dept_leader`  (
  ...
  INDEX `idx_tenant`(`tenant_id` ASC) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = 'Merchant部门领导' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = 'MMC 端登录日志' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = 'Merchant端菜单(全局共享)' ROW_FORMAT = Dynamic;
...
CREATE TABLE `mmc_operation_log`  (
  ...
  INDEX `idx_username`(`username` ASC) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = 'MMC 端操作日志' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '商户套餐表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '商户套餐-菜单关联' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = 'Merchant岗位' ROW_FORMAT = Dynamic;
...
CREATE TABLE `mmc_role`  (
  ...
  INDEX `idx_tenant_status`(`tenant_id` ASC, `status` ASC) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = 'Merchant角色' ROW_FORMAT = Dynamic;
...
CREATE TABLE `mmc_role_menu`  (
  ...
  INDEX `idx_tenant`(`tenant_id` ASC) USING BTREE,
  INDEX `idx_menu`(`menu_id` ASC) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = 'Merchant角色-菜单' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = 'MMC 端用户表(商户/分销商)' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = 'Merchant用户-部门' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = 'Merchant用户-岗位' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = 'Merchant用户-角色' ROW_FORMAT = Dynamic;
...
CREATE TABLE `notify_config`  (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '主键',
  `scene_code` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '场景编码: ticket_issued/flight_change/refund_done/approval_pending/monthly_bill/promotion等',
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '通知场景配置表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for notify_inbox
-- ----------------------------
DROP TABLE IF EXISTS `notify_inbox`;
CREATE TABLE `notify_inbox`  (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '主键',
  `user_id` bigint NOT NULL COMMENT '用户ID',
  `user_type` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'c_user' COMMENT '用户类型: c_user/mmc_user',
  `title` varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '标题',
  `content` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL COMMENT '内容',
  `biz_type` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '关联业务类型',
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '站内信表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `notify_log`  (
  ...
  `template_id` bigint NULL DEFAULT NULL COMMENT 'FK→notify_template.id',
  `user_id` bigint NOT NULL COMMENT '接收用户ID',
  `user_type` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'c_user' COMMENT '用户类型: c_user/mmc_user/tmc_user/pmc_user',
  `content` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL COMMENT '实际发送内容',
  `receiver` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '接收地址(手机号/openid/邮箱)',
  `send_status` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '发送状态: pending/sending/success/failed',
  `third_msg_id` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '第三方消息ID',
  ...
  INDEX `idx_trace_id`(`trace_id` ASC) USING BTREE,
  INDEX `idx_created_at`(`created_at` ASC) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '通知记录表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `notify_template`  (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '主键',
  `template_code` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '模板编码(唯一)',
  `template_name` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '模板名称',
  `channel` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '渠道: sms=短信, wechat=微信模板消息, miniprogram=小程序订阅消息, inbox=站内信, email=邮件',
  `template_content` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '模板内容(支持变量: {{var}})',
  `third_template_id` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '第三方模板ID(如微信模板ID)',
  `status` tinyint NOT NULL DEFAULT 1 COMMENT '状态: 0=禁用, 1=启用',
  `created_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `updated_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE,
...
-- ----------------------------
-- Table structure for oa_callback_log
-- ----------------------------
DROP TABLE IF EXISTS `oa_callback_log`;
CREATE TABLE `oa_callback_log`  (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '主键',
  `platform` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'OA平台',
  `event_type` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '事件类型: approval_status_change/user_add/dept_change等',
  `callback_id` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '回调ID(用于幂等)',
  `instance_id` bigint NULL DEFAULT NULL COMMENT '关联approval_instance.id',
  `request_headers` json NULL COMMENT '请求头(AES脱敏)',
  `request_body` json NULL COMMENT '请求体原文(加密存储,保留7天)',
  `process_result` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '处理结果: success=成功, duplicate=重复, failed=失败',
  `process_error` varchar(512) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '处理失败原因',
  ...
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `uk_callback_id`(`platform` ASC, `callback_id` ASC) USING BTREE,
  INDEX `idx_instance`(`instance_id` ASC) USING BTREE,
  INDEX `idx_event_type`(`event_type` ASC) USING BTREE,
  INDEX `idx_created_at`(`created_at` ASC) USING BTREE,
  INDEX `idx_trace_id`(`trace_id` ASC) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = 'OA回调日志表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `oa_config`  (
  ...
  `platform` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'OA平台: dingtalk=钉钉, feishu=飞书, wecom=企业微信',
  `is_enabled` tinyint NOT NULL DEFAULT 0 COMMENT '是否启用: 0=否, 1=是',
  `app_key` varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '应用Key/AppID/CorpID',
  `app_secret` varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '应用Secret(AES加密存储)',
  `agent_id` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '应用AgentID(钉钉)',
  `corp_id` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '企业ID(企微)',
  `callback_url` varchar(512) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '回调通知URL',
  `callback_token` varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '回调Token(AES加密存储)',
  `callback_aes_key` varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '回调AES Key(AES加密存储)',
  `process_mapping` json NULL COMMENT '审批流程映射: {\"travel_approval\":\"PROC-XXX\",\"expense_approval\":\"PROC-YYY\"}',
  `user_mapping_field` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'mobile' COMMENT '用户映射字段: mobile=手机号, email=邮箱, employee_id=工号',
  ...
  `extra_config` json NULL COMMENT '扩展配置(各平台特有参数)',
  `created_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `updated_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  `deleted_at` datetime NULL DEFAULT NULL COMMENT '软删除时间',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `uk_tenant_platform`(`tenant_id` ASC, `platform` ASC) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = 'OA平台配置表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for oa_user_mapping
-- ----------------------------
DROP TABLE IF EXISTS `oa_user_mapping`;
CREATE TABLE `oa_user_mapping`  (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '主键',
  `tenant_id` bigint NOT NULL COMMENT '租户ID',
  `platform` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'OA平台: dingtalk/feishu/wecom',
  `platform_user_id` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'OA平台用户ID',
  `platform_user_name` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT 'OA平台用户姓名',
  `platform_dept_id` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT 'OA平台部门ID',
  `local_user_type` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '本地用户类型: mmc=商户端, pmc=平台端, tmc=集团端, c=客户端',
  `local_user_id` bigint NOT NULL COMMENT '本地用户ID',
  `mapping_field` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '映射字段: mobile/email/employee_id',
  `mapping_value` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '映射值',
  `sync_at` datetime NULL DEFAULT NULL COMMENT '最近同步时间',
  `is_active` tinyint NOT NULL DEFAULT 1 COMMENT '是否有效: 0=失效, 1=有效',
  `created_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `updated_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `uk_platform_user`(`platform` ASC, `platform_user_id` ASC) USING BTREE,
  UNIQUE INDEX `uk_local_user`(`local_user_type` ASC, `local_user_id` ASC, `platform` ASC) USING BTREE,
  INDEX `idx_tenant`(`tenant_id` ASC) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = 'OA用户映射表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `open_api`  (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '主键',
  `api_code` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '接口编码(唯一)',
  `api_name` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '接口名称',
  `api_path` varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '接口路径 如 /openapi/v1/flight/search',
  `http_method` varchar(8) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'POST' COMMENT 'HTTP方法',
  `version` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'v1' COMMENT '版本号',
  `description` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL COMMENT '接口描述',
  `request_schema` json NULL COMMENT '请求参数Schema',
  `response_schema` json NULL COMMENT '响应参数Schema',
  `rate_limit_per_sec` int NULL DEFAULT NULL COMMENT '频率限制(次/秒)',
  `rate_limit_per_day` int NULL DEFAULT NULL COMMENT '频率限制(次/天)',
  `status` tinyint NOT NULL DEFAULT 1 COMMENT '状态: 0=禁用, 1=启用',
  `created_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `updated_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `uk_api_code_version`(`api_code` ASC, `version` ASC) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '开放平台API接口定义表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `open_api_auth`  (
  ...
  `updated_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `uk_tmc_api`(`tmc_tenant_id` ASC, `api_id` ASC) USING BTREE,
  INDEX `idx_api_id`(`api_id` ASC) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '开放平台API接口授权表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `open_api_log`  (
  ...
  INDEX `idx_api_id`(`api_id` ASC) USING BTREE,
  INDEX `idx_tmc_tenant_id`(`tmc_tenant_id` ASC) USING BTREE,
  INDEX `idx_trace_id`(`trace_id` ASC) USING BTREE,
  INDEX `idx_created_at`(`created_at` ASC) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '开放平台API调用日志表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `open_app`  (
  ...
  `app_key` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '应用AppKey',
  `app_secret` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '应用AppSecret(加密存储)',
  `ip_whitelist` json NULL COMMENT 'IP白名单(JSON数组)',
  `concurrency_limit` int NULL DEFAULT NULL COMMENT '并发限制',
  `rate_limit_per_sec` int NULL DEFAULT NULL COMMENT '频率限制(次/秒)',
  `rate_limit_per_day` int NULL DEFAULT NULL COMMENT '频率限制(次/天)',
  `status` tinyint NOT NULL DEFAULT 1 COMMENT '状态: 0=禁用, 1=启用',
  `created_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  ...
  INDEX `idx_tmc_tenant_id`(`tmc_tenant_id` ASC) USING BTREE,
  INDEX `idx_mmc_tenant_id`(`mmc_tenant_id` ASC) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '开放平台API应用表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for open_billing_config
-- ----------------------------
DROP TABLE IF EXISTS `open_billing_config`;
CREATE TABLE `open_billing_config`  (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '主键',
  `tmc_tenant_id` bigint NOT NULL COMMENT 'TMC租户ID',
  `billing_type` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '计费方式: per_call=按次, monthly=按月',
  `unit_price` decimal(12, 2) NULL DEFAULT NULL COMMENT '单价(按次时)',
  `monthly_price` decimal(12, 2) NULL DEFAULT NULL COMMENT '月费(按月时)',
  `monthly_call_limit` int NULL DEFAULT NULL COMMENT '月调用上限(按月时)',
  `effective_start` datetime NULL DEFAULT NULL COMMENT '生效开始',
  `effective_end` datetime NULL DEFAULT NULL COMMENT '生效结束',
  `status` tinyint NOT NULL DEFAULT 1 COMMENT '状态: 0=禁用, 1=启用',
  `created_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  ...
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_tmc_tenant_id`(`tmc_tenant_id` ASC) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '开放平台TMC计费配置表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `order`  (
  ...
  `created_at` datetime NULL DEFAULT NULL,
  `updated_at` datetime NULL DEFAULT NULL,
  `order_tag` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '订单来源标识: openapi=开放平台, mini_program=小程序, web=Web端, app=App端',
  `trace_id` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '全链路追踪ID',
  PRIMARY KEY (`id`) USING BTREE,
...
CREATE TABLE `order_item_car`  (
  ...
  `service_type` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '服务类型: airport_pickup/airport_dropoff/city/cross_city',
  ...
  `car_no` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '车牌号',
  `fee_detail` json NULL COMMENT '费用明细',
...
CREATE TABLE `pmc_role_menu`  (
  ...
  UNIQUE INDEX `uk_role_menu`(`role_id` ASC, `menu_id` ASC) USING BTREE,
  INDEX `idx_menu`(`menu_id` ASC) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = 'SaaS角色-菜单' ROW_FORMAT = Dynamic;
...
CREATE TABLE `pmc_user_dept`  (
  ...
  INDEX `idx_dept`(`dept_id` ASC) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = 'PMC用户-部门' ROW_FORMAT = Dynamic;
...
CREATE TABLE `pmc_user_position`  (
  ...
  INDEX `idx_position`(`position_id` ASC) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = 'PMC用户-岗位' ROW_FORMAT = Dynamic;
...
CREATE TABLE `pricing_rule`  (
  ...
  `tenant_type` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '租户类型: tmc=集团, mmc=商户',
  `rule_name` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '规则名称',
  `product_type` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '产品类型: flight/hotel/train',
  `markup_type` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '加价类型: fixed=固定加价, percent=比例加价, mixed=固定+比例',
  `fixed_amount` decimal(12, 2) NULL DEFAULT NULL COMMENT '固定加价金额',
  `percent_rate` decimal(5, 4) NULL DEFAULT NULL COMMENT '浮动比例(0.0500=5%)',
  `min_markup` decimal(12, 2) NULL DEFAULT NULL COMMENT '最低加价(比例时保底)',
  `max_markup` decimal(12, 2) NULL DEFAULT NULL COMMENT '最高加价(比例时封顶)',
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '加价规则表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for procurement_account
-- ----------------------------
...
CREATE TABLE `procurement_account`  (
  ...
  `tmc_tenant_id` bigint NOT NULL COMMENT 'TMC租户ID',
  `account_name` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '账号名称',
  `account_no` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '账号',
  `account_config` json NULL COMMENT '认证配置(加密存储)',
  `quota_limit` int NULL DEFAULT NULL COMMENT '调用配额限制',
  `quota_used` int NULL DEFAULT NULL COMMENT '已使用配额',
  `status` tinyint NOT NULL DEFAULT 1 COMMENT '状态: 0=禁用, 1=启用',
  `created_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `updated_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  `deleted_at` datetime NULL DEFAULT NULL COMMENT '软删除时间',
  ...
  INDEX `idx_tmc_tenant_id`(`tmc_tenant_id` ASC) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '采购渠道账号表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for procurement_channel
-- ----------------------------
DROP TABLE IF EXISTS `procurement_channel`;
CREATE TABLE `procurement_channel`  (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '主键',
  `channel_code` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '渠道编码(唯一)',
  `channel_name` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '渠道名称',
  `channel_type` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '渠道类型: airline_b2b=航司B2B, travelport=中航信, third_party=第三方接口, manual=人工外采',
  `supplier_type` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '供应类型: flight=机票, hotel=酒店, train=火车票, insurance=保险',
  `api_url` varchar(512) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '接口地址',
  `api_config` json NULL COMMENT '接口配置(认证方式/参数映射)',
  `status` tinyint NOT NULL DEFAULT 1 COMMENT '状态: 0=禁用, 1=启用',
  `created_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `updated_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  `deleted_at` datetime NULL DEFAULT NULL COMMENT '软删除时间',
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '采购渠道表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for procurement_reconciliation
-- ----------------------------
DROP TABLE IF EXISTS `procurement_reconciliation`;
CREATE TABLE `procurement_reconciliation`  (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '主键',
  `tmc_tenant_id` bigint NOT NULL COMMENT 'TMC租户ID',
  `batch_no` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '导入批次号',
  `order_id` bigint NULL DEFAULT NULL COMMENT '关联订单ID',
  `order_item_id` bigint NULL DEFAULT NULL COMMENT '关联订单项ID',
  `pnr` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT 'PNR',
  `ticket_no` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '票号',
  `procurement_price` decimal(12, 2) NULL DEFAULT NULL COMMENT '采购价',
  `status` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '状态: pending=待核销, matched=已匹配, failed=匹配失败',
  `trace_id` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '全链路追踪ID',
  `created_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `updated_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE,
  ...
  INDEX `idx_order_id`(`order_id` ASC) USING BTREE,
  INDEX `idx_trace_id`(`trace_id` ASC) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '外采核销记录表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for procurement_rule
-- ----------------------------
DROP TABLE IF EXISTS `procurement_rule`;
CREATE TABLE `procurement_rule`  (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '主键',
  `tenant_id` bigint NOT NULL COMMENT '规则所属租户(0=PMC全局)',
  `tenant_type` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '租户类型: pmc=平台, tmc=集团, mmc=商户',
  `rule_name` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '规则名称',
  `product_type` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '产品类型: flight/hotel/train',
  `airline_code` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '航司代码(空=不限)',
  `departure_code` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '出发城市代码',
  `arrival_code` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '到达城市代码',
  `cabin_class` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '舱位等级',
  `price_min` decimal(12, 2) NULL DEFAULT NULL COMMENT '金额范围-最小',
  `price_max` decimal(12, 2) NULL DEFAULT NULL COMMENT '金额范围-最大',
  `time_start` time NULL DEFAULT NULL COMMENT '有效时间-开始',
  `time_end` time NULL DEFAULT NULL COMMENT '有效时间-结束',
  `week_days` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '有效星期(1-7逗号分隔)',
  `channel_id` bigint NULL DEFAULT NULL COMMENT 'FK→procurement_channel.id',
  `procurement_type` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '采购方式: auto=自动, manual=手动',
  `verify_threshold_type` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '验价阈值类型: percent=百分比, fixed=固定值',
  `verify_threshold_value` decimal(12, 2) NULL DEFAULT NULL COMMENT '验价阈值',
  ...
  INDEX `idx_product_type`(`product_type` ASC) USING BTREE,
  INDEX `idx_channel_id`(`channel_id` ASC) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '自动采购规则表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for procurement_verify_log
-- ----------------------------
...
CREATE TABLE `procurement_verify_log`  (
  ...
  `channel_id` bigint NULL DEFAULT NULL COMMENT 'FK→procurement_channel.id',
  `cache_price` decimal(12, 2) NULL DEFAULT NULL COMMENT '缓存价格',
  `real_price` decimal(12, 2) NULL DEFAULT NULL COMMENT '实时验价',
  `threshold_type` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '验价阈值类型',
  `threshold_value` decimal(12, 2) NULL DEFAULT NULL COMMENT '验价阈值',
  `price_diff` decimal(12, 2) NULL DEFAULT NULL COMMENT '价格差异',
  `verify_result` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '验价结果: pass=通过, fail=不通过, retry=重试',
  `trace_id` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '全链路追踪ID',
  `created_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_order_id`(`order_id` ASC) USING BTREE,
  INDEX `idx_channel_id`(`channel_id` ASC) USING BTREE,
  INDEX `idx_trace_id`(`trace_id` ASC) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '采购验价日志表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for profit_sharing_log
-- ----------------------------
DROP TABLE IF EXISTS `profit_sharing_log`;
CREATE TABLE `profit_sharing_log`  (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '主键',
  `rule_id` bigint NULL DEFAULT NULL COMMENT 'FK→profit_sharing_rule.id',
  ...
  `calc_detail` json NULL COMMENT '计算明细',
  `status` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '状态: pending=待结算, settled=已结算, failed=失败',
  ...
  INDEX `idx_order_id`(`order_id` ASC) USING BTREE,
  INDEX `idx_from_tenant`(`from_tenant_id` ASC) USING BTREE,
  INDEX `idx_to_tenant`(`to_tenant_id` ASC) USING BTREE,
  INDEX `idx_status`(`status` ASC) USING BTREE,
  INDEX `idx_trace_id`(`trace_id` ASC) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '分润记录表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for profit_sharing_rule
-- ----------------------------
...
CREATE TABLE `profit_sharing_rule`  (
  ...
  `rule_name` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '规则名称',
  `product_type` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '产品类型: flight/hotel/train',
  `calc_type` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '计算方式: fixed=固定金额, percent=比例, tiered=阶梯',
  `calc_config` json NULL COMMENT '计算配置(固定值/比例值/阶梯规则)',
  `sharing_timing` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '分润时机: order=按订单, period=按周期',
  `period_type` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '周期类型: weekly=周, monthly=月(按周期时)',
  `status` tinyint NOT NULL DEFAULT 1 COMMENT '状态: 0=禁用, 1=启用',
  `created_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `updated_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  `deleted_at` datetime NULL DEFAULT NULL COMMENT '软删除时间',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_tenant`(`tenant_id` ASC) USING BTREE,
  INDEX `idx_target_tenant`(`target_tenant_id` ASC) USING BTREE
...
CREATE TABLE `promotion_activity`  (
  ...
  `activity_type` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '活动类型: seckill=秒杀, group_buy=团购, full_reduction=满减, flash_sale=闪购',
  ...
  INDEX `idx_status`(`status` ASC) USING BTREE,
  INDEX `idx_effective_time`(`effective_start` ASC, `effective_end` ASC) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '促销活动表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `queue_task`  (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '主键',
  `task_type` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '任务类型: ticket_issue/refund/price_verify/batch_import/bill_generate等',
  ...
  `snapshot` json NULL COMMENT '业务数据快照(创建时业务数据副本, 用于版本回溯)',
  ...
  `status` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'pending' COMMENT '状态: pending=待执行, running=执行中, success=成功, failed=失败, cancelled=已取消',
  ...
  `next_run_at` datetime NULL DEFAULT NULL COMMENT '下次执行时间(延迟任务)',
  `created_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `updated_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE,
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '队列任务表(含版本快照控制)' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for report_snapshot
-- ----------------------------
...
CREATE TABLE `report_snapshot`  (
  ...
  `tenant_id` bigint NOT NULL COMMENT '租户ID',
  `tenant_type` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '租户类型: pmc/tmc/mmc',
  `report_type` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '报表类型: sales=销售, procurement=采购, finance=财务, user=用户, product=产品',
  `dimension` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '维度: daily=日, weekly=周, monthly=月',
  `dimension_date` date NOT NULL COMMENT '维度日期',
  `metrics` json NOT NULL COMMENT '指标数据(订单量/销售额/采购额/退款额/利润等)',
  `created_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `uk_report_dimension`(`tenant_id` ASC, `tenant_type` ASC, `report_type` ASC, `dimension` ASC, `dimension_date` ASC) USING BTREE,
  INDEX `idx_tenant`(`tenant_id` ASC, `tenant_type` ASC) USING BTREE,
  INDEX `idx_report_type`(`report_type` ASC) USING BTREE,
  INDEX `idx_dimension_date`(`dimension_date` ASC) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '报表快照表' ROW_FORMAT = Dynamic;
...
-- ----------------------------
-- Table structure for service_fee_rule
-- ----------------------------
DROP TABLE IF EXISTS `service_fee_rule`;
CREATE TABLE `service_fee_rule`  (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '主键',
  `tenant_id` bigint NOT NULL COMMENT '租户ID',
  `tenant_type` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '租户类型: tmc/mmc',
  `rule_name` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '规则名称',
  `product_type` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '产品类型: flight/hotel/train',
  `fee_type` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '费用类型: booking=订座费, ticketing=出票费, refund=退票费, change=改签费, service=服务费',
  `calc_type` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '计算方式: fixed=固定, percent=比例, tiered=阶梯',
  `tiered_config` json NULL COMMENT '阶梯配置',
  `status` tinyint NOT NULL DEFAULT 1 COMMENT '状态: 0=禁用, 1=启用',
  `created_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `updated_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  `deleted_at` datetime NULL DEFAULT NULL COMMENT '软删除时间',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_tenant`(`tenant_id` ASC, `tenant_type` ASC) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '服务费规则表' ROW_FORMAT = Dynamic;
...
-- ----------------------------
-- Table structure for settlement_config
-- ----------------------------
...
CREATE TABLE `settlement_config`  (
  ...
  `target_tenant_type` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '下级类型: mmc=商户, tmc=集团',
  `settlement_type` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '结算方式: prepaid=预付, monthly=月结, credit=信用额度, mixed=混合',
  `credit_amount` decimal(14, 2) NULL DEFAULT NULL COMMENT '信用额度',
  `credit_used` decimal(14, 2) NOT NULL DEFAULT 0.00 COMMENT '已使用信用额度',
  `credit_warning_rate` decimal(5, 4) NULL DEFAULT NULL COMMENT '额度预警比例(0.8000=80%)',
  `credit_frozen` tinyint NOT NULL DEFAULT 0 COMMENT '是否冻结(0=否, 1=是)',
  `monthly_settle_day` int NULL DEFAULT NULL COMMENT '月结出账日(每月几号)',
  `monthly_payment_day` int NULL DEFAULT NULL COMMENT '月结付款日(每月几号前)',
  `payment_terms` int NULL DEFAULT NULL COMMENT '付款期限(天)',
  `status` tinyint NOT NULL DEFAULT 1 COMMENT '状态: 0=禁用, 1=启用',
  `created_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `updated_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_tenant_id`(`tenant_id` ASC) USING BTREE,
  INDEX `idx_target_tenant`(`target_tenant_id` ASC, `target_tenant_type` ASC) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '结算方式配置表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `sign_in_log`  (
  ...
  `created_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `uk_user_mmc_date`(`user_id` ASC, `mmc_tenant_id` ASC, `sign_date` ASC) USING BTREE,
  INDEX `idx_user_id`(`user_id` ASC) USING BTREE,
...
CREATE TABLE `sign_in_rule`  (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '主键',
  `mmc_tenant_id` bigint NOT NULL COMMENT '商户ID',
  `reward_type` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '奖励类型: point=积分, coupon=优惠券',
  `reward_amount` int NOT NULL DEFAULT 0 COMMENT '奖励数量/积分值',
  `reward_coupon_id` bigint NULL DEFAULT NULL COMMENT '奖励优惠券ID',
  `continuous_days` int NOT NULL DEFAULT 7 COMMENT '连续签到天数要求',
  `continuous_bonus` int NOT NULL DEFAULT 0 COMMENT '连续签到额外奖励',
  `continuous_bonus_coupon_id` bigint NULL DEFAULT NULL COMMENT '连续签到额外优惠券ID',
  `status` tinyint NOT NULL DEFAULT 1 COMMENT '状态: 0=禁用, 1=启用',
  `created_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `updated_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_mmc_tenant_id`(`mmc_tenant_id` ASC) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '签到规则表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `supplier`  (
  ...
  `supplier_type` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '供应商类型: airline=航司, hotel=酒店, insurance=保险, car=用车, ticket=门票, other=其他',
  ...
  `contract_no` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '合同编号',
  `contract_start` date NULL DEFAULT NULL COMMENT '合同开始日期',
  `contract_end` date NULL DEFAULT NULL COMMENT '合同结束日期',
  `settlement_type` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '结算方式: prepaid=预付, monthly=月结, credit=信用额度',
  `bank_name` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '开户行',
  `bank_account` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '银行账号',
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '通用供应商管理表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '多租户套餐' ROW_FORMAT = Dynamic;
...
CREATE TABLE `tmc_user`  (
  ...
  INDEX `idx_phone_hash`(`phone_hash` ASC) USING BTREE,
  INDEX `idx_email_hash`(`email_hash` ASC) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = 'TMC 端用户表' ROW_FORMAT = Dynamic;
...
-- ----------------------------
-- Table structure for travel_policy
-- ----------------------------
...
CREATE TABLE `travel_policy`  (
  ...
  `tenant_id` bigint NOT NULL COMMENT '租户ID',
  `tenant_type` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '租户类型: tmc/mmc',
  `policy_name` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '政策名称',
  `rules` json NOT NULL COMMENT '政策规则(航线限制/舱位限制/价格上限/酒店标准/火车席别标准等)',
  `violation_action` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'warn' COMMENT '违规处理: warn=仅提醒, block=拦截禁止',
  `apply_scope` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'all' COMMENT '适用范围: all=全员, department=按部门, specified=指定人员',
  `scope_config` json NULL COMMENT '范围配置(部门ID列表/人员ID列表)',
  `status` tinyint NOT NULL DEFAULT 1 COMMENT '状态: 0=禁用, 1=启用',
  `created_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `updated_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  `deleted_at` datetime NULL DEFAULT NULL COMMENT '软删除时间',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_tenant`(`tenant_id` ASC, `tenant_type` ASC) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '差旅政策表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `user_tag`  (
  ...
  `tenant_id` bigint NOT NULL COMMENT '租户ID',
  `tenant_type` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '租户类型: pmc/tmc/mmc',
  `tag_name` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '标签名称',
  `tag_color` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '标签颜色',
  `tag_type` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'manual' COMMENT '标签类型: manual=手动, auto=自动',
  `auto_rule` json NULL COMMENT '自动打标规则(自动标签时)',
  ...
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_tenant`(`tenant_id` ASC, `tenant_type` ASC) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '用户标签定义表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `user_tag_relation`  (
  ...
  `user_id` bigint NOT NULL COMMENT 'C端用户ID',
  `source` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'manual' COMMENT '来源: manual=手动, auto=自动',
  `created_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `uk_tag_user`(`tag_id` ASC, `user_id` ASC) USING BTREE,
  INDEX `idx_user_id`(`user_id` ASC) USING BTREE
